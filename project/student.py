...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\face-recognition.png")
        ...
        #second image
        img1=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\smart-attendance.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\iStock-182059956_18390_t12.jpg")
        ...
        #back ground image
        img3=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\wp2551980.jpg")
        ...
        main_frame.place(x=10,y=43,width=1500,height=600)

        #lef tlable frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=1,width=660,height=510)

        
        img_left=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\AdobeStock_303989091.jpeg")
        ...
        current_course_frame.place(x=5,y=105,width=646,height=100)
        ...
        dep_combo["values"]=("Select Department","Computer","IT","Civil","Mechnical","Sports")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","FE","SE","TE","BE","Other")
        ...
        class_Student_frame.place(x=5,y=205,width=646,height=280)
       ...
       #radio buttons
        ...
        radionbtn1.grid(row=5,column=0,padx=10,pady=5,sticky=W)
 
        
        radionbtn2=ttk.Radiobutton(class_Student_frame,variable=self.var_radio1,text="No photo sample",value="NO")
        radionbtn2.grid(row=5,column=1,padx=10,pady=5,sticky=W)
 
        #buttons frame
        btn_frame=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame.place(x=0,y=180,width=640,height=30)
        ...
        btn_frame1.place(x=0,y=210,width=640,height=30)        
        ...
        img_right=Image.open(r"C:\Users\dell\AppData\Local\Programs\Python\Python39\libs\college_images\gettyimages-1022573162.jpg")
        ...
        Search_frame.place(x=5,y=115,width=646,height=70)
        ...
        table_frame.place(x=5,y=190,width=646,height=300)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="mysqldb@4212",database="face_recog_systm")
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                Update=messagebox.askyesno("Update","Do you want to update this stdent details",parent=self.root)
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="mysqldb@4212",database="face_recog_systm")
                    my_cursor=conn.cursor()
    ...
    def reset_data(self):
        ...
        self.var_course.set("Seplect Course")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                #====================Load predifinr data on face frontals from opencv==================
