...
class Attendance:
    def __init__(self,root):
        ...
        img3=img3.resize((1530,515),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bg_img=Label(self.root,image=self.photoimg3)
        bg_img.place(x=0,y=200,width=1530,height=515)
        ...
        main_frame.place(x=10,y=43,width=1340,height=600)
        ...
        left_inside_frame.place(x=0,y=135,width=656,height=370)
        ...
        btn_frame.place(x=0,y=250,width=640,height=30)
        ...
        table_frame.place(x=5,y=5,width=644,height=400)
